...
public class SearchBase {
    ...
    public  void SearchBase(FileOutputStream  p, DataOutputStream pout ) throws IOException {


     	      this.p =p;
	      this.pout = pout;//make work and flush
    ...
    public boolean process(int depth_limit, Lab8Frame f)  throws IOException{
		frame = f;
	...
	public int idaSearch(PassBoolean done, int limit, StateSpace ssp, SearchList open2)  throws IOException{
	    open=open2;
	...
	public int search(PassBoolean done, int limit, StateSpace ssp, SearchList open2)  throws IOException{
	    open=open2;
	...
	public int vectorSearch(PassBoolean done, int limit, StateSpace ssp) throws IOException{ 
			
		return search(done,limit,ssp,new VectorasList());
	}
	
	public int vectorSearch2(PassBoolean done, int limit, StateSpace ssp)  throws IOException{
		
		return idaSearch(done,limit,ssp,new VectorasList());
	}


	public int bestFirstSearch(PassBoolean done, int limit, StateSpace ssp)  throws IOException{
